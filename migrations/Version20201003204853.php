 ...
 */
final class Version20201003204853 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE movie (id VARCHAR(255) NOT NULL, primary_title VARCHAR(255) NOT NULL, original_title VARCHAR(255) NOT NULL, is_adult TINYINT(1) DEFAULT NULL, start_year VARCHAR(255) DEFAULT NULL, end_year VARCHAR(255) DEFAULT NULL, runtime_minutes VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE movie_name_profession (id INT AUTO_INCREMENT NOT NULL, movie_id VARCHAR(255) DEFAULT NULL, name_id VARCHAR(255) DEFAULT NULL, profession_id INT DEFAULT NULL, INDEX IDX_17AB13858F93B6FC (movie_id), INDEX IDX_17AB138571179CD6 (name_id), INDEX IDX_17AB1385FDEF8996 (profession_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE name (id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, birth_year INT NOT NULL, death_year INT NOT NULL, nconst VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE profession_name (profession_id INT NOT NULL, name_id VARCHAR(255) NOT NULL, INDEX IDX_84318367FDEF8996 (profession_id), INDEX IDX_8431836771179CD6 (name_id), PRIMARY KEY(profession_id, name_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
